...
import {SUCCESS, INTERNAL_SERVER_ERROR, NOF_FOUND, VALIDATION_RESPONSE} from '../helpers/status.codes.helper';
    ...
    static create = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            if (model) {
                ...
                return response(VALIDATION_RESPONSE, res, model, 'Cannot create new user');
            }
        } catch (error) {
            return response(INTERNAL_SERVER_ERROR, res, error);
        }
    ...
    static update = async (req: Request, res: Response) => {
        try {
            ...
            if (model) {
                ...
                return response(VALIDATION_RESPONSE, res, model, 'Cannot update new user');
            }
        } catch (error) {
            return response(INTERNAL_SERVER_ERROR, res, error);
        }
